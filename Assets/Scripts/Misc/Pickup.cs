...
{
    [SerializeField] private float pickupDiatance = 5f;
    ...
    private void Update()
    {
        ...
        if (Vector3.Distance(transform.position, playerPos) < pickupDiatance)
        {
    ...
    private IEnumerator AnimCurveSpawnRoutine()
    {
        ...
        float randomY = transform.position.y + Random.Range(-0.5f, 0.5f);
